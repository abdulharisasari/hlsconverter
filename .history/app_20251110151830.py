...
def start_ffmpeg_to_hls(source_url: str, output_name: str):
    ...
    # Gunakan DEVNULL biar tidak menggantung
    ...
    while True:
        ...
        for stream_id, info in list(active_streams.items()):
            ...
            if age > EXPIRE_MINUTES:
                ...
                try:
                    # Skip kalau FFmpeg masih nulis file (cek modifikasi < 1 menit)
                    if os.path.exists(folder):
                        ...
                        if (time.time() - latest_mod) < 60:
                            continue  # masih aktif, lewati dulu
...
def convert_stream():
    ...
    # Jalankan konversi jika belum aktif
