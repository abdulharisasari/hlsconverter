...
coba dibagian @app.route("/livestream/iOS/<token>")
def play_camera(token):
itu ketika kelamaan maka akan retri otomatis ketika sudah maksimal retry maka kasih response conntection timeout atau video offline 
