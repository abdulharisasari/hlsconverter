...
#     stream_id = str(camera_id)  # langsung pakai cameraId, tidak hash

#     if stream_id not in active_streams:
#         # Ambil streamingURL dari API eksternal
#         try:
#             api_url = f"https://i-see.iconpln.co.id/backenddev/api/View/EmbedStaticLink?cameraId={camera_id}"
...
#         # Jalankan convert jika belum ada
...
#     # Update last_access & tandai sudah diputar
...
#         video {{ width: 80%; max-width: 800px; border-radius: 12px; box-shadow: 0 0 20px rgba(0,0,0,0.5); }}
#         </style>
#         </head>
#         <body>
...
def play_camera(camera_id):
    ...
    try:
        ...
        api_url = f"https://192.168.62.170:7246/api/View/EmbedStaticLink?token=CfDJ8D2gho2u4zhIkj8bQVqNM7-ux5saZR59iBLzFWz3aRu7Ijru2855AeBR8LqgHRq2gvrYS_Wq-lYxUbhfnvP1aRGyE9WOeHAjiWcu3zp0xcT0XLObTgHr65cSnLzBoEFodF-70y5xAIIlXxVRxGJlgp95mFpvkPw9-EH17Tvbv_EXlIYZnk3XHwMlS8ENVHaXze_HWKQkA-fiiuC-hz-87TU"
