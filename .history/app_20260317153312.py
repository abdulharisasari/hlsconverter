...
def play_camera(token):
    ...
    try:
        ...
        if not streaming_url:
            print(f"[WARNING] streaming_url kosong! data0={data0}")
        else:
        ...
        return f"<h2>Error ambil streamingURL: {e}</h2>", 500
    ...
    <body>
        ...
        <script>
            ...
            if (!streamingUrl) {{
                console.warn("Streaming URL kosong atau offline:", streamingUrl);
            }} else if (video) {{
