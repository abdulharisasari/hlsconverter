...
# =====================================
# HELPER: Generate Token dari CameraId
# =====================================
...
@app.route("/")
def hello():
    return "iOS Streaming Proxy Running"
...
def generate_link_ios():
    ...
    try:
        ...
        streaming_url = f"{BASE_STREAM_SERVER}/livestream/iOS/{token}?cameraId={camera_id}"
...
def livestream_ios(token):
    ...
    stream_url = f"{BASE_API}/api/View/GetCameraStream?token={token}"
            ...
            setInterval(async () => {{
                try {{
                    ...
                    if (data.streamingUrl) {{
                        ...
                        loadStream(
                            "{BASE_API}/api/View/GetCameraStream?token=" + data.token
                        );
                    }}
                }}
                catch (e) {{
                    console.log("Gagal refresh token", e);
                }}
            }}, 240000); // 4 menit
